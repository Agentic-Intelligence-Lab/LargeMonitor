...
def build_continual_dataloader(args):
    if args.dataset in ('ImageNet-CU', 'Imagenet-CU', 'Split-ImageNet-CU'):
        import sys
        ...
        from largemonitor.imagenet_cu import build_continual_dataloader as build_imagenet_cu

        return build_imagenet_cu(args)
