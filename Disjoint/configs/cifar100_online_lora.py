...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--checkpoint-path', default='', type=str, help='Local timm weights file or HF model dir (skips download)')
    ...
    subparsers.add_argument('--output-dir', '--output_dir', default='./output', dest='output_dir',
                        help='path where to save logs, decisions, and checkpoints')
