...
def init_ckpt_path(output_dir='./output', loglevel=logging.INFO):
    """Return checkpoint path under ``output_dir/checkpoints/``."""
    taskfolder = os.path.join(output_dir, 'checkpoints')
